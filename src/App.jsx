...
// ─────────────────────────────────────────────────────────
//  RULES-BASED BRAND STATEMENT GENERATOR
//  No API. No dependencies. Instant. Never fails.
// ─────────────────────────────────────────────────────────

// Sentence 1 templates per niche — uses deliverables + tools
const S1_TEMPLATES = {
  ecom:    (tool, deliverable) => `${deliverable} for eCommerce brands using ${tool}, turning store operations into systems that convert browsers into repeat buyers.`,
  social:  (tool, deliverable) => `${deliverable} for growing brands using ${tool}, building content systems that drive consistent engagement without the chaos.`,
  exec:    (tool, deliverable) => `${deliverable} for busy executives using ${tool}, creating the operational clarity that lets founders focus on decisions that matter.`,
  content: (tool, deliverable) => `${deliverable} for online businesses using ${tool}, producing content that ranks, converts, and positions clients as authorities in their space.`,
  realty:  (tool, deliverable) => `${deliverable} for real estate teams using ${tool}, keeping pipelines organised so agents spend more time closing and less time chasing leads.`,
  books:   (tool, deliverable) => `${deliverable} for service-based businesses using ${tool}, translating messy financial data into clean records that clients can actually act on.`,
  cx:      (tool, deliverable) => `${deliverable} for online businesses using ${tool}, resolving customer issues with the speed and consistency that builds long-term loyalty.`,
  health:  (tool, deliverable) => `${deliverable} for healthcare providers using ${tool}, keeping patient records and schedules running with zero room for administrative error.`,
  legal:   (tool, deliverable) => `${deliverable} for law firms using ${tool}, managing case files and client communications with the precision the legal industry demands.`,
  edu:     (tool, deliverable) => `${deliverable} for course creators using ${tool}, building the backend systems that keep students engaged and programmes running on schedule.`,
  media:   (tool, deliverable) => `${deliverable} for content creators using ${tool}, turning raw recordings into polished productions that grow audiences and keep sponsors happy.`,
  pm:      (tool, deliverable) => `${deliverable} for growing teams using ${tool}, building the project infrastructure that keeps deliverables on track and stakeholders informed.`,
};

// Sentence 2 templates — uses background + target market
const S2_TEMPLATES = {
  exec:    (bg, market) => `${bg} built the organisational discipline that ${market} clients pay a premium for in a VA who never needs to be managed.`,
  books:   (bg, market) => `${bg} provided the analytical foundation that ${market} business owners rely on when they need numbers they can trust.`,
  social:  (bg, market) => `${bg} developed the communication instincts that ${market} brands need to stay visible in feeds built to forget them.`,
  content: (bg, market) => `${bg} sharpened the writing discipline that ${market} businesses need to consistently produce content that earns authority over time.`,
  realty:  (bg, market) => `${bg} developed the research precision that ${market} real estate teams depend on to stay ahead of a market that moves fast.`,
  cx:      (bg, market) => `${bg} built the people skills that ${market} businesses rely on to turn difficult interactions into five-star reviews.`,
  health:  (bg, market) => `${bg} provided the accuracy habits that ${market} healthcare providers need when every scheduling error has real consequences.`,
  legal:   (bg, market) => `${bg} built the attention to detail that ${market} law firms require when no document can afford to be wrong.`,
  edu:     (bg, market) => `${bg} developed the instructional instincts that ${market} course creators need to build programmes students actually complete.`,
  media:   (bg, market) => `${bg} developed the production eye that ${market} creators need to stand out in a content landscape drowning in average.`,
  ecom:    (bg, market) => `${bg} built the systems thinking that ${market} eCommerce brands need to scale operations without losing control of quality.`,
  pm:      (bg, market) => `${bg} developed the process discipline that ${market} teams need to deliver complex projects without the chaos of missed handoffs.`,
};

// Extract readable background from q01 + q02
function getBackground(ans) {
  ...
  const eduMap = {
    "Business, Commerce, or Management": "A background in business",
    "Communications, Journalism, or Marketing": "A background in communications",
    "IT, Computer Science, or Engineering": "A technical background in IT",
    "Education, Humanities, or Liberal Arts": "A background in education",
    "Finance, Accounting, or Economics": "A background in finance",
    "Real Estate, Law, or Property-related": "A background in real estate and law",
    "Healthcare, Nursing, or Medical Sciences": "A background in healthcare",
    "Not yet finished / currently studying": "An ongoing academic background",
    "Other or unrelated field": "A cross-disciplinary background",
  };

  const expMap = {
    "Office admin, secretary, or executive support": "Years of admin and executive support experience",
    "Retail, sales, or online selling": "Direct experience in sales and online retail",
    "Social media, marketing, or advertising": "Hands-on experience in social media and marketing",
    "Writing, editing, blogging, or journalism": "A writing and editorial background",
    "Finance, accounting, or bookkeeping": "Direct experience in finance and bookkeeping",
    "Customer service or call center (BPO)": "BPO and customer service experience",
    "Real estate, property, or banking": "Direct experience in real estate and banking",
    "Healthcare, clinic, or medical admin": "Clinical and medical admin experience",
    "Legal, paralegal, or law firm work": "Paralegal and law firm experience",
    "Teaching, tutoring, or training": "A background in teaching and instructional design",
    "Video, podcast production, or media": "Direct experience in media production",
    "Fresh graduate — no work experience yet": "An academic background",
  };
...
// Extract target market label from q07
function getMarket(ans) {
  const marketMap = {
    "US clients — highest rates, EST/PST timezone": "US",
    "Australian clients — strong market, AEST zone": "Australian",
    "UK or European clients — growing VA demand": "UK and European",
    "Canadian clients — healthcare and legal VA demand": "Canadian",
    "Local Philippine businesses — easier comms": "local Philippine",
    "Any market — wherever the opportunity is best": "international",
  };
  const opt = ans.q07 !== undefined ? QS[6].opts[ans.q07]?.t : null;
  return (opt && marketMap[opt]) ? marketMap[opt] : "international";
}

// Pick best tool from q04 selections based on niche
const NICHE_TOOL_PRIORITY = {
  ecom:    ["Shopify / Lazada / Shopee","Google Workspace","Mailchimp / ActiveCampaign","Notion / Trello / Asana"],
  social:  ["Canva or Adobe Photoshop","Facebook / Instagram / TikTok","CapCut or Adobe Premiere","Mailchimp / ActiveCampaign"],
  exec:    ["Google Workspace","Notion / Trello / Asana","Zoom or Calendly","LinkedIn"],
  content: ["WordPress or Wix","ChatGPT or Jasper","Google Workspace","Canva or Adobe Photoshop"],
  ...
  cx:      ["Zendesk / Freshdesk / Gorgias","HubSpot / Salesforce / CRM","Google Workspace","Facebook / Instagram / TikTok"],
  health:  ["EMR or medical scheduling","Zoom or Calendly","Google Workspace","Kareo"],
  legal:   ["Clio or MyCase","Google Workspace","LinkedIn","DocuSign"],
  edu:     ["Kajabi / Teachable / Thinkific","Zoom or Calendly","Notion / Trello / Asana","ChatGPT or Jasper"],
  media:   ["Descript or Audacity","CapCut or Adobe Premiere","Canva or Adobe Photoshop","Riverside.fm"],
  pm:      ["Notion / Trello / Asana","Airtable or Monday.com","Google Workspace","HubSpot / Salesforce / CRM"],
};

// Clean tool name for prose
const TOOL_CLEAN = {
  "Shopify / Lazada / Shopee": "Shopify",
  "Google Workspace": "Google Workspace",
  "Mailchimp / ActiveCampaign": "email automation tools",
  "Notion / Trello / Asana": "Notion",
  "Canva or Adobe Photoshop": "Canva",
  "Facebook / Instagram / TikTok": "social platforms",
  "CapCut or Adobe Premiere": "CapCut",
  "Zoom or Calendly": "Calendly",
  "WordPress or Wix": "WordPress",
  "ChatGPT or Jasper": "AI writing tools",
  "HubSpot / Salesforce / CRM": "CRM tools",
  "QuickBooks or Xero": "QuickBooks",
  "Airtable or Monday.com": "Airtable",
  "Zendesk / Freshdesk / Gorgias": "Gorgias",
  "EMR or medical scheduling": "medical scheduling systems",
  "Clio or MyCase": "Clio",
  "Kajabi / Teachable / Thinkific": "Kajabi",
  "Descript or Audacity": "Descript",
  "LinkedIn": "LinkedIn",
};
...
function getBestTool(ans, primary) {
  ...
  for (const p of priority) {
    if (selected.includes(p)) return TOOL_CLEAN[p] || p;
  }
  // fallback to niche default tool
  const fallbacks = { ecom:"Shopify", social:"Canva", exec:"Google Workspace", content:"WordPress", realty:"CRM tools", books:"QuickBooks", cx:"Gorgias", health:"medical scheduling systems", legal:"Clio", edu:"Kajabi", media:"Descript", pm:"Notion" };
  return fallbacks[primary] || "industry-standard tools";
}

// Deliverable per niche
const DELIVERABLES = {
  ecom:    "Managing product listings, order workflows, and customer data",
  social:  "Creating and scheduling content across platforms",
  exec:    "Managing calendars, inboxes, and executive workflows",
  content: "Researching, writing, and publishing SEO-optimised content",
  realty:  "Managing listings, leads, and transaction coordination",
  books:   "Reconciling accounts, categorising transactions, and producing reports",
  cx:      "Handling tickets, resolving escalations, and managing customer communications",
  health:  "Coordinating patient scheduling, records, and administrative workflows",
  legal:   "Managing case files, deadlines, and client correspondence",
  edu:     "Building course infrastructure, managing enrolments, and coordinating student support",
  media:   "Editing, producing, and distributing podcast and video content",
  pm:      "Tracking deliverables, coordinating teams, and maintaining project documentation",
};

function generateBrandStatement(ans, primary, secondary) {
  const n1 = NICHES[primary];
  const tool = getBestTool(ans, primary);
  const deliverable = DELIVERABLES[primary] || `Delivering specialist ${n1.label} services`;
  const background = getBackground(ans);
  const market = getMarket(ans);

  const s1fn = S1_TEMPLATES[primary] || S1_TEMPLATES.exec;
  const s2fn = S2_TEMPLATES[primary] || S2_TEMPLATES.exec;

  const s1 = s1fn(tool, deliverable);
  const s2 = s2fn(background, market);
...
export default function NicheSelector() {
  ...
  const submitGate = async () => {
    ...
    const typoTLDs  = /\.(con|cmo|ocm|cpm|coj|vom|xom)$/i;
    if (!emailRegex.test(email.trim()) || typoTLDs.test(email.trim())) { setEmailErr(true); return; }
    setEmailErr(false);
    try {
    ...
    // Generate brand statement instantly — no API call
    if (result) {
      const statement = generateBrandStatement(newAns || ans, result.primary, result.secondary);
      setBrand(statement);
    }
    setPhase("results");
  };
  ...
  const regen = () => {
    if (!result) return;
    // Cycle through a variation by regenerating (same logic, always works)
    const statement = generateBrandStatement(ans, result.primary, result.secondary);
    setBrand(statement);
  };
  ...
  return (
    <div className="app">
      ...
      {phase === "landing" && (
        <main className="main">
          ...
          <div className="meta-row fade-up-3">
            {[["11","Niches mapped"],["12","Questions"],["5 min","To complete"],["Free","Brand statement"]].map(([n,l]) => (
      ...
      {phase === "results" && result && pn && sn && (
        <main className="main">
          ...
          <div style={{marginBottom:40,paddingBottom:40,borderBottom:"1px solid #ebebeb"}}>
            <span className="section-lbl" style={{marginBottom:20}}>Full Compatibility Breakdown · All 11 Niches</span>
          ...
          {/* Rate reference */}
          <div style={{marginBottom:40}}>
            <span className="section-lbl" style={{marginBottom:0}}>All 11 Niche Rate Ranges · 2025–2026 Philippine VA Market</span>
      ...
      {phase === "gate" && (
        <main className="main fade-up">
          ...
          <p className="q-sub" style={{marginBottom:32}}>
            Your niche match and personalised brand statement are ready. Enter your email to unlock them — we'll also send you the free tools built for your niche.
          </p>
      ...
      <footer className="ftr">
        ...
        <span className="ftr-r">Niche Selector Engine · 11 Niches · <a href="https://systems.marginmomentum.co" style={{color:"#fff",textDecoration:"none",letterSpacing:"2px"}}>← Back to Free Tools</a></span>
      </footer>
    </div>
  );
}
